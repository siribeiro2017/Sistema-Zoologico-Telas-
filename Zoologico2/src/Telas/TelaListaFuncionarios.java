...
public class TelaListaFuncionarios extends javax.swing.JFrame {
    public static ArrayList<FuncaoTela> func = new ArrayList<>();
    
    static{ // bloco inicializador
        func.add(new FuncaoTela("Danilo", 28, 99999999));
        func.add(new FuncaoTela("Anna", 32, 11112222));
        func.add(new FuncaoTela("Isa", 40, 55554444));
